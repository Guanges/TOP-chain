...
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(min_eth_group_size);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(max_eth_group_size);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(eth_statistic_report_schedule_interval);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(eth_reward_ratio);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(eth_group_zero_workload);
...
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(eth_to_top_exchange_ratio);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(tgas_to_eth_gas_exchange_ratio);
